...
CREATE VIEW vista_ordenes_clientes_vendedores AS
SELECT 
  o.id_orden,
  o.fecha,
  o.total,
...
CREATE VIEW vista_detalle_ordenes AS
SELECT 
  do.id_detalle,
  do.id_orden,
  p.nombre_producto,
...
CREATE VIEW Vista_Totales_Orden AS
SELECT 
    o.id_orden,
